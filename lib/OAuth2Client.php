<?php
include __DIR__ . "/OAuth2Exception.php";
/**
...
abstract class OAuth2Client {
   ...
   *
   * Automatically append "access_token" in query parameters if not yet
   * exists and able to discover a valid access token from session. Otherwise
   * just ignore setup with "access_token" and handle the API call AS-IS, and
  ...
  protected function makeOAuth2Request($path, $method = 'GET', $params = array()) {
    if ((!isset($params['access_token']) || empty($params['access_token'])) && $access_token = $this->getAccessToken()) {
